...
Tests hypotheses against evidence, contradictions, alternatives, gaps, and disconfirming facts without forcing conclusions. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft investigative hypothesis test.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to investigative hypothesis test.
...
- Canonical taxonomy dependency: `generate-investigative-hypotheses`.
...
- Read `references/test-investigative-hypothesis-reference.md` when preparing investigative hypothesis test outputs.
