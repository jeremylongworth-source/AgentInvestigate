# Analyze Pattern Of Events Reference

## When To Read

Read this reference when using `analyze-pattern-of-events` for evidence matrices, hypotheses, hypothesis testing, alternative explanations, contradictions, chronologies, pattern analysis, source weight, finding confidence, unresolved questions, or draft investigative findings.
