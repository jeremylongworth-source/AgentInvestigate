...
Analyzes event patterns, recurrence, clustering, chronology, source limits, alternatives, and contradictory indicators. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft pattern-of-events analysis.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to pattern-of-events analysis.
...
- Read `references/analyze-pattern-of-events-reference.md` when preparing pattern-of-events analysis outputs.
