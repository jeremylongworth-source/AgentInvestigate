...
Identifies unresolved questions, missing evidence, untested alternatives, and follow-up actions. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft unresolved investigative question.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to unresolved investigative question.
...
- Canonical taxonomy dependency: `assess-finding-confidence`.
...
- Read `references/identify-unresolved-question-reference.md` when preparing unresolved investigative question outputs.
