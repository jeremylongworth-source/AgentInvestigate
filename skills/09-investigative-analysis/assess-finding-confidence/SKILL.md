...
Assesses finding confidence from support, contradiction, source weight, alternative explanations, and unresolved questions. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft finding confidence assessment.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to finding confidence assessment.
...
- Canonical taxonomy dependency: `compare-alternative-explanations`.
...
- Read `references/assess-finding-confidence-reference.md` when preparing finding confidence assessment outputs.
