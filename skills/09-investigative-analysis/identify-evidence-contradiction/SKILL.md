...
Identifies evidence contradictions, source conflicts, chronology conflicts, assumptions, and follow-up needs. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft evidence contradiction.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to evidence contradiction.
...
- Read `references/identify-evidence-contradiction-reference.md` when preparing evidence contradiction outputs.
