...
Compares plausible explanations, support, contradictions, missing evidence, and disconfirming indicators. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft alternative explanation comparison.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to alternative explanation comparison.
...
- Canonical taxonomy dependency: `test-investigative-hypothesis`.
...
- Read `references/compare-alternative-explanations-reference.md` when preparing alternative explanation comparison outputs.
