...
Drafts scoped findings with supporting facts, source limits, confidence, contradictions, alternatives, and unresolved questions. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft investigative finding.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to investigative finding.
...
- Read `references/draft-investigative-finding-reference.md` when preparing investigative finding outputs.
