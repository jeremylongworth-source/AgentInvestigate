# Construct Event Chronology Reference

## When To Read

Read this reference when using `construct-event-chronology` for evidence matrices, hypotheses, hypothesis testing, alternative explanations, contradictions, chronologies, pattern analysis, source weight, finding confidence, unresolved questions, or draft investigative findings.
