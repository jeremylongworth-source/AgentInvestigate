...
Constructs chronologies that separate dated facts, estimated times, allegations, inferences, gaps, and conflicts. This is a `ROUTINE` investigative-analysis skill for professional investigation support.

## Triggers

- User asks to generate, test, compare, identify, construct, analyze, assess, or draft event chronology.
...
- Case scope, investigative question, allegation, hypothesis, chronology, source set, evidence matrix, or draft finding relevant to event chronology.
...
- Canonical taxonomy dependency: `create-case-timeline`.
...
- Read `references/construct-event-chronology-reference.md` when preparing event chronology outputs.
