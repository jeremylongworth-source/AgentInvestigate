...
Assesses vulnerability categories, exposed assets, controls, gaps, assumptions, and qualified-review needs. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare physical vulnerabilities.
...
- Supplied facts relevant to physical vulnerabilities, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `identify-security-threats`.
...
- risk register or assessment elements relevant to physical vulnerabilities;
...
- Read `references/assess-physical-vulnerabilities-reference.md` when preparing physical vulnerabilities outputs.
