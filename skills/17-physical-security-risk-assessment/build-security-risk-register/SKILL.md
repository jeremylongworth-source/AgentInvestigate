...
Builds risk registers that link assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, and owners. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare security risk register.
...
- Supplied facts relevant to security risk register, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `assess-risk-likelihood`.
- Canonical taxonomy dependency: `assess-security-consequences`.
...
- risk register or assessment elements relevant to security risk register;
...
- Read `references/build-security-risk-register-reference.md` when preparing security risk register outputs.
