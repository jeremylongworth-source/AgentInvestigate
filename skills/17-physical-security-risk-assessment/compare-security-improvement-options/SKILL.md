...
Compares improvement options by risk reduction, feasibility, dependencies, cost signals, tradeoffs, and review gates. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare security improvement options.
...
- Supplied facts relevant to security improvement options, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `identify-control-gaps`.
...
- risk register or assessment elements relevant to security improvement options;
...
- Read `references/compare-security-improvement-options-reference.md` when preparing security improvement options outputs.
