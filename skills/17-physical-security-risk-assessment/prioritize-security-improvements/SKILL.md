...
Prioritizes improvements with rationale, dependencies, residual risk, owner candidates, and review requirements. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare prioritized security improvements.
...
- Supplied facts relevant to prioritized security improvements, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `compare-security-improvement-options`.
...
- risk register or assessment elements relevant to prioritized security improvements;
...
- Read `references/prioritize-security-improvements-reference.md` when preparing prioritized security improvements outputs.
