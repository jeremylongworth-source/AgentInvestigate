...
Prepares assessment summaries that preserve reasoning, assumptions, limits, gaps, options, and prioritized improvements. This is a `REGULATED` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare physical security assessment summary.
...
- Supplied facts relevant to physical security assessment summary, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `prioritize-security-improvements`.
...
- risk register or assessment elements relevant to physical security assessment summary;
...
- Read `references/prepare-physical-security-assessment-summary-reference.md` when preparing physical security assessment summary outputs.
