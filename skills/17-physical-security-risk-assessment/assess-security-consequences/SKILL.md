...
Assesses consequences to people, operations, property, information, compliance, reputation, and continuity. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare security consequences.
...
- Supplied facts relevant to security consequences, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `assess-physical-vulnerabilities`.
...
- risk register or assessment elements relevant to security consequences;
...
- Read `references/assess-security-consequences-reference.md` when preparing security consequences outputs.
