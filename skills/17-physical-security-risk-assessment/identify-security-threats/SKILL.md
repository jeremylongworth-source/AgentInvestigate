...
Identifies threat categories, affected assets, source basis, assumptions, likelihood inputs, and review needs. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare security threats.
...
- Supplied facts relevant to security threats, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- risk register or assessment elements relevant to security threats;
...
- Read `references/identify-security-threats-reference.md` when preparing security threats outputs.
