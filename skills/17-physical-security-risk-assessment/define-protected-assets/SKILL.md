...
Defines assets, people, operations, information, spaces, dependencies, and assessment boundaries for physical security analysis. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare protected assets.
...
- Supplied facts relevant to protected assets, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- risk register or assessment elements relevant to protected assets;
...
- Read `references/define-protected-assets-reference.md` when preparing protected assets outputs.
