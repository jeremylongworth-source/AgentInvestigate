...
Identifies control gaps, residual exposure, unsupported assumptions, missing evidence, and review needs. This is a `ROUTINE` physical security and risk assessment skill for professional security support.
...
- User asks to define, identify, assess, build, map, compare, prioritize, or prepare control gaps.
...
- Supplied facts relevant to control gaps, including assets, threats, vulnerabilities, consequences, likelihood, risk, controls, gaps, options, and prioritized improvements where applicable.
...
- Canonical taxonomy dependency: `map-existing-controls`.
...
- risk register or assessment elements relevant to control gaps;
...
- Read `references/identify-control-gaps-reference.md` when preparing control gaps outputs.
