...
Triage security incidents by urgency, safety indicators, known facts, escalation path, notification needs, and documentation gaps. This is a `CERTIFICATION_BOUNDARY` incident response skill for professional security support.
...
- User asks to triage, determine, support, preserve, identify, document, collect, prepare, assess, draft, adapt, review, or communicate security incident triage.
...
- Supplied facts relevant to security incident triage, including dates, times, locations, people or roles, observations, incident conditions, communications, notifications, actions already taken, records, and open issues where applicable.
...
- Read `references/triage-security-incident-reference.md` when preparing security incident triage outputs.
