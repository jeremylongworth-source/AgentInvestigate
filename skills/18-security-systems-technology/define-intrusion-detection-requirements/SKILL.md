...
Defines intrusion detection requirements for zones, signals, monitoring, response documentation, and review gates. This is a `REGULATED` security systems and technology skill for professional security support.
...
- User asks to define, analyze, assess, identify, or prepare intrusion-detection requirements.
...
- Supplied facts relevant to intrusion-detection requirements, including access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, and requirements where applicable.
...
- Read `references/define-intrusion-detection-requirements-reference.md` when preparing intrusion-detection requirements outputs.
