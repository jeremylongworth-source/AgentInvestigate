# Prepare Security System Requirements Summary Reference

## When To Read

Read this reference when using `prepare-security-system-requirements-summary` for security systems and technology work involving access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, requirements, privacy, technical review, or qualified-review escalation.
