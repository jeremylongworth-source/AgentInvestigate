...
Prepares requirements summaries that preserve system scope, controls, privacy, failure risks, gaps, and review boundaries. This is a `REGULATED` security systems and technology skill for professional security support.
...
- User asks to define, analyze, assess, identify, or prepare security-system requirements summary.
...
- Supplied facts relevant to security-system requirements summary, including access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, and requirements where applicable.
...
- Canonical taxonomy dependency: `define-access-control-requirements`.
- Canonical taxonomy dependency: `define-intrusion-detection-requirements`.
...
- Read `references/prepare-security-system-requirements-summary-reference.md` when preparing security-system requirements summary outputs.
