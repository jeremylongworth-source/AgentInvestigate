...
Defines access-control requirements, roles, zones, authorization needs, audit records, and qualified-review gates. This is a `REGULATED` security systems and technology skill for professional security support.
...
- User asks to define, analyze, assess, identify, or prepare access-control requirements.
...
- Supplied facts relevant to access-control requirements, including access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, and requirements where applicable.
...
- Read `references/define-access-control-requirements-reference.md` when preparing access-control requirements outputs.
