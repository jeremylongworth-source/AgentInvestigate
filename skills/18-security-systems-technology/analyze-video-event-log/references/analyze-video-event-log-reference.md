# Analyze Video Event Log Reference

## When To Read

Read this reference when using `analyze-video-event-log` for security systems and technology work involving access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, requirements, privacy, technical review, or qualified-review escalation.
