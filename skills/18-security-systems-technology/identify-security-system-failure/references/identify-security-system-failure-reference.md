# Identify Security System Failure Reference

## When To Read

Read this reference when using `identify-security-system-failure` for security systems and technology work involving access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, requirements, privacy, technical review, or qualified-review escalation.
