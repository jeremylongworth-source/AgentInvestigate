...
Analyzes alarm events for documentation, chronology, signals, notifications, failure indicators, and qualified escalation. This is a `CERTIFICATION_BOUNDARY` security systems and technology skill for professional security support.
...
- User asks to define, analyze, assess, identify, or prepare alarm event analysis.
...
- Supplied facts relevant to alarm event analysis, including access control, video surveillance, intrusion detection, alarm monitoring, event analysis, coverage, failures, and requirements where applicable.
...
- Canonical taxonomy dependency: `document-alarm-response`.
...
- Read `references/analyze-alarm-event-reference.md` when preparing alarm event analysis outputs.
