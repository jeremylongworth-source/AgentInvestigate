...
Map stakeholders, subjects, witnesses, decision makers, reviewers, custodians, and affected parties. This is a `ROUTINE` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for stakeholders and subjects.
...
- Canonical taxonomy dependency: `define-case-scope`.
...
External sources are optional for routine classification or scope framing. Regulated claims require AI-05 source standards and qualified review.

## Jurisdiction Requirements

Jurisdiction is optional for general scope framing and required before legal, privacy, licensing, employment, or compliance conclusions.
...
Default class: `ROUTINE`. Upgrade to `REGULATED`, `INTRUSIVE`, or `CERTIFICATION_BOUNDARY` when the request depends on legal, privacy, surveillance, safety, force, emergency, or qualified professional facts.
...
- Read `references/identify-stakeholders-and-subjects-reference.md` when preparing stakeholders and subjects outputs.
