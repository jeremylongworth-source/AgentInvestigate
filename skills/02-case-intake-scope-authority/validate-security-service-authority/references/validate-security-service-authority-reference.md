# Validate Security Service Authority Reference

## When To Read

Read this reference when using `validate-security-service-authority` for intake, authority, law, licensing, privacy, or compliance routing.
