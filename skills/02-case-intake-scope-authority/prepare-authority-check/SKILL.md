...
Prepare authority questions, evidence needs, gate status, missing facts, and escalation targets for review. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for authority check.
...
- Read `references/prepare-authority-check-reference.md` when preparing authority check outputs.
