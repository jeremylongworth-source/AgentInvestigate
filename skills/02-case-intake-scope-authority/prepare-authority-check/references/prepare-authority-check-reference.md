# Prepare Authority Check Reference

## When To Read

Read this reference when using `prepare-authority-check` for intake, authority, law, licensing, privacy, or compliance routing.
