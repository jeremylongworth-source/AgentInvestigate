...
Assess the stated purpose for legitimacy, scope fit, affected parties, prohibited intent, and required review. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for lawful purpose.
...
- Read `references/assess-lawful-purpose-reference.md` when preparing lawful purpose outputs.
