...
Identify possible jurisdictions that may govern the supplied work and preserve unknown or conflicting jurisdiction facts. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for jurisdiction.
...
- Read `references/identify-jurisdiction-reference.md` when preparing jurisdiction outputs.
