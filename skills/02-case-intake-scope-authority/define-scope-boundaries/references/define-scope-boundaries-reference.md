# Define Scope Boundaries Reference

## When To Read

Read this reference when using `define-scope-boundaries` for intake, authority, law, licensing, privacy, or compliance routing.
