...
Translate case scope into permitted activities, excluded activities, gate conditions, and stop points. This is a `ROUTINE` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for scope boundaries.
...
- Read `references/define-scope-boundaries-reference.md` when preparing scope boundaries outputs.
