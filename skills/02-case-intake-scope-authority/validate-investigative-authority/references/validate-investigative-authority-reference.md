# Validate Investigative Authority Reference

## When To Read

Read this reference when using `validate-investigative-authority` for intake, authority, law, licensing, privacy, or compliance routing.
