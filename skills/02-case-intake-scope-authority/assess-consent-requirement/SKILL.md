...
Identify possible consent, notice, authorization, and human-review questions for the supplied work. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for consent requirement.
...
- Canonical taxonomy dependency: `identify-stakeholders-and-subjects`.
...
- Read `references/assess-consent-requirement-reference.md` when preparing consent requirement outputs.
