# Assess Consent Requirement Reference

## When To Read

Read this reference when using `assess-consent-requirement` for intake, authority, law, licensing, privacy, or compliance routing.
