...
Identify the requester's role, relationship to the matter, and claimed authority without accepting unsupported authority claims. This is a `ROUTINE` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for client role.
...
- Canonical taxonomy dependency: `classify-request-type`.
...
- Read `references/identify-client-role-reference.md` when preparing client role outputs.
