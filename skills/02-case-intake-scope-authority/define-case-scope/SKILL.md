...
Define the matter objective, in-scope work, out-of-scope work, constraints, and missing intake facts. This is a `ROUTINE` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for case scope.
...
- Canonical taxonomy dependency: `assess-lawful-purpose`.
...
- Read `references/define-case-scope-reference.md` when preparing case scope outputs.
