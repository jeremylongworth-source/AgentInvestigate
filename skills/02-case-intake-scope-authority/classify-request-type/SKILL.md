...
Classify the supplied request into investigation, research, security, compliance, incident, screening, or out-of-scope work types. This is a `ROUTINE` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for request type.
...
- Read `references/classify-request-type-reference.md` when preparing request type outputs.
