# Normalize Person Identifiers Reference

## When To Read

Read this reference when using `normalize-person-identifiers` for identity, entity, identifier, relationship, association, timeline, contradiction, or confidence analysis.
