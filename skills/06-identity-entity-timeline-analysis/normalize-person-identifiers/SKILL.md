...
Structures supplied person identifiers, aliases, dates, contact points, and source references for review. This is an `INTRUSIVE` identity, entity, and timeline analysis skill for source-bounded professional investigation work.

## Triggers

- User asks to assess, differentiate, normalize, construct, map, resolve, or state person identifiers.
...
- Canonical taxonomy dependency: `assess-information-collection-basis`.
...
- Read `references/normalize-person-identifiers-reference.md` when preparing person identifiers outputs.
