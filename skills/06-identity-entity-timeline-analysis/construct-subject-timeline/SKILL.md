...
Builds a subject timeline from supplied records while preserving date uncertainty, source limits, and identity ambiguity. This is an `INTRUSIVE` identity, entity, and timeline analysis skill for source-bounded professional investigation work.

## Triggers

- User asks to assess, differentiate, normalize, construct, map, resolve, or state subject timeline.
...
- Read `references/construct-subject-timeline-reference.md` when preparing subject timeline outputs.
