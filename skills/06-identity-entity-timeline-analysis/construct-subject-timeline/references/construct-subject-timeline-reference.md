# Construct Subject Timeline Reference

## When To Read

Read this reference when using `construct-subject-timeline` for identity, entity, identifier, relationship, association, timeline, contradiction, or confidence analysis.
