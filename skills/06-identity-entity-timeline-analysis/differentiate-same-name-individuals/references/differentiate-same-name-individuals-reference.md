# Differentiate Same Name Individuals Reference

## When To Read

Read this reference when using `differentiate-same-name-individuals` for identity, entity, identifier, relationship, association, timeline, contradiction, or confidence analysis.
