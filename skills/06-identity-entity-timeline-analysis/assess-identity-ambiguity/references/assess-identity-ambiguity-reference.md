# Assess Identity Ambiguity Reference

## When To Read

Read this reference when using `assess-identity-ambiguity` for identity, entity, identifier, relationship, association, timeline, contradiction, or confidence analysis.
