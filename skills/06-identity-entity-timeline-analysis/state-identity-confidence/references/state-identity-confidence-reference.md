# State Identity Confidence Reference

## When To Read

Read this reference when using `state-identity-confidence` for identity, entity, identifier, relationship, association, timeline, contradiction, or confidence analysis.
