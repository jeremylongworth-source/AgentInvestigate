# Normalize Organization Identifiers Reference

## When To Read

Read this reference when using `normalize-organization-identifiers` for identity, entity, identifier, relationship, association, timeline, contradiction, or confidence analysis.
