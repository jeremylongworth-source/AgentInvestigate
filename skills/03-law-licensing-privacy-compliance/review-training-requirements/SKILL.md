...
Identify training, licensing, certification, policy, and supervisor review questions for the supplied work. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for training requirements.
...
- Canonical taxonomy dependency: `identify-licensing-requirement`.
...
- Read `references/review-training-requirements-reference.md` when preparing training requirements outputs.
