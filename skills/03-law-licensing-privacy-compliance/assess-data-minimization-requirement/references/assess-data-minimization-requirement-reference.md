# Assess Data Minimization Requirement Reference

## When To Read

Read this reference when using `assess-data-minimization-requirement` for intake, authority, law, licensing, privacy, or compliance routing.
