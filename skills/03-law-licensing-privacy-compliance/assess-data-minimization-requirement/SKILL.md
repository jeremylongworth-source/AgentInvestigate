...
Identify whether requested data appears necessary, excessive, duplicative, sensitive, or ready for redaction. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for data minimization requirement.
...
- Read `references/assess-data-minimization-requirement-reference.md` when preparing data minimization requirement outputs.
