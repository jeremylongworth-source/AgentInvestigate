# Identify Regulated Activity Reference

## When To Read

Read this reference when using `identify-regulated-activity` for intake, authority, law, licensing, privacy, or compliance routing.
