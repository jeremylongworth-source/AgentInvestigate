...
Issue-spot regulated activity indicators and route to authoritative source research or qualified review. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for regulated activity.
...
- Read `references/identify-regulated-activity-reference.md` when preparing regulated activity outputs.
