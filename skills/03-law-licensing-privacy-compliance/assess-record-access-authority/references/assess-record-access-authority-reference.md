# Assess Record Access Authority Reference

## When To Read

Read this reference when using `assess-record-access-authority` for intake, authority, law, licensing, privacy, or compliance routing.
