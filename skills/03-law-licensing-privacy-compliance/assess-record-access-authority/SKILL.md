...
Assess claimed record-access authority, source ownership, consent or authorization evidence, and review needs. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for record access authority.
...
- Read `references/assess-record-access-authority-reference.md` when preparing record access authority outputs.
