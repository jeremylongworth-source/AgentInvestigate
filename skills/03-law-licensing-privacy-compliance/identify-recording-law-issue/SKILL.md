...
Identify recording-law issues, consent unknowns, privacy gates, and prohibited monitoring boundaries. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for recording law issue.
...
- Read `references/identify-recording-law-issue-reference.md` when preparing recording law issue outputs.
