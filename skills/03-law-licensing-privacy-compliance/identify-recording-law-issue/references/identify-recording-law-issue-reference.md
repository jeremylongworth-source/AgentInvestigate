# Identify Recording Law Issue Reference

## When To Read

Read this reference when using `identify-recording-law-issue` for intake, authority, law, licensing, privacy, or compliance routing.
