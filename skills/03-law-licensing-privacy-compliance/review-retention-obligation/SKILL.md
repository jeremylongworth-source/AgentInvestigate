...
Identify retention, legal hold, preservation, disposal, and reviewer questions without setting final retention periods. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for retention obligation.
...
- Read `references/review-retention-obligation-reference.md` when preparing retention obligation outputs.
