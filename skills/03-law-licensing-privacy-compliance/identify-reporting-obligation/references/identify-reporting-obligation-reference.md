# Identify Reporting Obligation Reference

## When To Read

Read this reference when using `identify-reporting-obligation` for intake, authority, law, licensing, privacy, or compliance routing.
