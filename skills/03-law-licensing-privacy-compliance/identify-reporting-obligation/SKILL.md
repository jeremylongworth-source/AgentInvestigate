...
Identify possible reporting triggers, notification questions, responsible reviewers, timing risks, and unknowns. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for reporting obligation.
...
- Read `references/identify-reporting-obligation-reference.md` when preparing reporting obligation outputs.
