...
Prepare a concise escalation brief with issue, facts, sources needed, missing authority, risk, and reviewer target. This is a `REGULATED` control-layer skill for intake, authority, law, licensing, privacy, and compliance routing.

## Triggers

- User asks to classify, scope, validate, or prepare review for compliance escalation.
...
- Canonical taxonomy dependency: `identify-regulated-activity`.
...
- Read `references/prepare-compliance-escalation-reference.md` when preparing compliance escalation outputs.
