# Assess Information Collection Basis Reference

## When To Read

Read this reference when using `assess-information-collection-basis` for intake, authority, law, licensing, privacy, or compliance routing.
