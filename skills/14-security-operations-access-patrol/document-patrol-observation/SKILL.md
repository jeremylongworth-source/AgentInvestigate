...
Documents patrol observations with neutral facts, locations, timestamps, source limits, and follow-up needs. This is a `ROUTINE` security operations, access, and patrol skill for professional security support.
...
- User asks to review, build, plan, document, log, verify, triage, record, prepare, or identify patrol observation.
...
- Supplied facts relevant to patrol observation, including dates, times, locations, people or roles, access points, alarm zones, patrol points, visitor details, key identifiers, notifications, actions taken, and open issues where applicable.
...
- Canonical taxonomy dependency: `plan-patrol-route`.
...
- Read `references/document-patrol-observation-reference.md` when preparing patrol observation outputs.
