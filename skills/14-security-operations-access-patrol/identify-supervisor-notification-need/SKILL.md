...
Identifies supervisor notification needs, urgency, records to preserve, and handoff details from supplied security facts. This is a `ROUTINE` security operations, access, and patrol skill for professional security support.
...
- User asks to review, build, plan, document, log, verify, triage, record, prepare, or identify supervisor notification need.
...
- Supplied facts relevant to supervisor notification need, including dates, times, locations, people or roles, access points, alarm zones, patrol points, visitor details, key identifiers, notifications, actions taken, and open issues where applicable.
...
- Read `references/identify-supervisor-notification-need-reference.md` when preparing supervisor notification need outputs.
