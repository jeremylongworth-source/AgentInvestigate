# Document Alarm Response Reference

## When To Read

Read this reference when using `document-alarm-response` for security operations, access, patrol, post orders, shift plans, patrol observations, access events, visitor issues, key control, alarm documentation, occurrences, handoffs, log review, post-order gaps, operations briefs, or supervisor notifications.
