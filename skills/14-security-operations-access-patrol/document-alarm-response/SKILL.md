...
Documents alarm response under post orders with certification-boundary escalation and no building-clearing or alarm-bypass advice. This is a `CERTIFICATION_BOUNDARY` security operations, access, and patrol skill for professional security support.
...
- User asks to review, build, plan, document, log, verify, triage, record, prepare, or identify alarm response.
...
- Supplied facts relevant to alarm response, including dates, times, locations, people or roles, access points, alarm zones, patrol points, visitor details, key identifiers, notifications, actions taken, and open issues where applicable.
...
- Canonical taxonomy dependency: `review-post-orders`.
...
- Read `references/document-alarm-response-reference.md` when preparing alarm response outputs.
