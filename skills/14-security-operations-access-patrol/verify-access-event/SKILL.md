...
Verifies access-event documentation and identifies identity, authorization, record, and escalation gaps. This is a `ROUTINE` security operations, access, and patrol skill for professional security support.
...
- User asks to review, build, plan, document, log, verify, triage, record, prepare, or identify access event.
...
- Supplied facts relevant to access event, including dates, times, locations, people or roles, access points, alarm zones, patrol points, visitor details, key identifiers, notifications, actions taken, and open issues where applicable.
...
- Read `references/verify-access-event-reference.md` when preparing access event outputs.
