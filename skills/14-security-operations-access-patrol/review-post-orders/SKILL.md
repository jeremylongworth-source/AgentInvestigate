...
Reviews post orders for authorized duties, site rules, escalation paths, log requirements, and operational gaps. This is a `REGULATED` security operations, access, and patrol skill for professional security support.
...
- User asks to review, build, plan, document, log, verify, triage, record, prepare, or identify post order review.
...
- Supplied facts relevant to post order review, including dates, times, locations, people or roles, access points, alarm zones, patrol points, visitor details, key identifiers, notifications, actions taken, and open issues where applicable.
...
- Canonical taxonomy dependency: `validate-security-service-authority`.
...
- Read `references/review-post-orders-reference.md` when preparing post order review outputs.
