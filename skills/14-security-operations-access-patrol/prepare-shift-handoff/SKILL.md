...
Prepares concise shift handoffs that preserve open items, risks, notifications, records, and next-shift awareness. This is a `ROUTINE` security operations, access, and patrol skill for professional security support.
...
- User asks to review, build, plan, document, log, verify, triage, record, prepare, or identify shift handoff.
...
- Supplied facts relevant to shift handoff, including dates, times, locations, people or roles, access points, alarm zones, patrol points, visitor details, key identifiers, notifications, actions taken, and open issues where applicable.
...
- Read `references/prepare-shift-handoff-reference.md` when preparing shift handoff outputs.
