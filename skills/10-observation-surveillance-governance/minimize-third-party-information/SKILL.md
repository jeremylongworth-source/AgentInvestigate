...
Flags bystander, incidental, excessive, irrelevant, or sensitive third-party information for minimization and review. This is an `INTRUSIVE` observation and surveillance governance skill. It requires jurisdiction, documented authority, lawful purpose, privacy review, minimization, and human review before any bounded output.
...
- User asks to assess, define, plan, record, minimize, or review third-party information minimization.
...
- Proposed or supplied observation scope relevant to third-party information minimization.
...
- Canonical taxonomy dependency: `record-field-observation`.
...
- Read `references/minimize-third-party-information-reference.md` when preparing third-party information minimization outputs.
