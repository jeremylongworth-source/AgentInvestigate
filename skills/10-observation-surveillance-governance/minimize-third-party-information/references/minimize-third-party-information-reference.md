# Minimize Third Party Information Reference

## When To Read

Read this reference when using `minimize-third-party-information` for observation authorization, necessity, purpose, assignment governance, field records, third-party minimization, or compliance review.
