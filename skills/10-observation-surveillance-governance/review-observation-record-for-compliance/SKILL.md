...
Reviews observation records for authorization, jurisdiction, scope, minimization, privacy, retention, and escalation gaps. This is an `INTRUSIVE` observation and surveillance governance skill. It requires jurisdiction, documented authority, lawful purpose, privacy review, minimization, and human review before any bounded output.
...
- User asks to assess, define, plan, record, minimize, or review observation compliance review.
...
- Proposed or supplied observation scope relevant to observation compliance review.
...
- Canonical taxonomy dependency: `minimize-third-party-information`.
...
- Read `references/review-observation-record-for-compliance-reference.md` when preparing observation compliance review outputs.
