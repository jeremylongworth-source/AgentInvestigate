# Plan Lawful Observation Assignment Reference

## When To Read

Read this reference when using `plan-lawful-observation-assignment` for observation authorization, necessity, purpose, assignment governance, field records, third-party minimization, or compliance review.
