...
Structures field observation notes while separating facts, inferences, third-party information, and review needs. This is an `INTRUSIVE` observation and surveillance governance skill. It requires jurisdiction, documented authority, lawful purpose, privacy review, minimization, and human review before any bounded output.
...
- User asks to assess, define, plan, record, minimize, or review field observation record.
...
- Proposed or supplied observation scope relevant to field observation record.
...
- Canonical taxonomy dependency: `plan-lawful-observation-assignment`.
...
- Read `references/record-field-observation-reference.md` when preparing field observation record outputs.
