# Record Field Observation Reference

## When To Read

Read this reference when using `record-field-observation` for observation authorization, necessity, purpose, assignment governance, field records, third-party minimization, or compliance review.
