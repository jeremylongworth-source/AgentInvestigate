# Assess Observation Necessity Reference

## When To Read

Read this reference when using `assess-observation-necessity` for observation authorization, necessity, purpose, assignment governance, field records, third-party minimization, or compliance review.
