...
Reviews necessity, purpose fit, alternatives, and stop conditions without creating an operational surveillance plan. This is an `INTRUSIVE` observation and surveillance governance skill. It requires jurisdiction, documented authority, lawful purpose, privacy review, minimization, and human review before any bounded output.
...
- User asks to assess, define, plan, record, minimize, or review observation necessity.
...
- Proposed or supplied observation scope relevant to observation necessity.
...
- Canonical taxonomy dependency: `assess-observation-authorization`.
...
- Read `references/assess-observation-necessity-reference.md` when preparing observation necessity outputs.
