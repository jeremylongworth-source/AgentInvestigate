...
Checks observation authorization gates without providing operational surveillance tactics. This is an `INTRUSIVE` observation and surveillance governance skill. It requires jurisdiction, documented authority, lawful purpose, privacy review, minimization, and human review before any bounded output.
...
- User asks to assess, define, plan, record, minimize, or review observation authorization.
...
- Proposed or supplied observation scope relevant to observation authorization.
...
- Canonical taxonomy dependency: `validate-investigative-authority`.
...
- Read `references/assess-observation-authorization-reference.md` when preparing observation authorization outputs.
