# Assess Observation Authorization Reference

## When To Read

Read this reference when using `assess-observation-authorization` for observation authorization, necessity, purpose, assignment governance, field records, third-party minimization, or compliance review.
