...
Defines observation purpose, scope limits, minimization needs, and review gates without operational tactics. This is an `INTRUSIVE` observation and surveillance governance skill. It requires jurisdiction, documented authority, lawful purpose, privacy review, minimization, and human review before any bounded output.
...
- User asks to assess, define, plan, record, minimize, or review observation purpose.
...
- Proposed or supplied observation scope relevant to observation purpose.
...
- Canonical taxonomy dependency: `assess-observation-proportionality`.
...
- Read `references/define-observation-purpose-reference.md` when preparing observation purpose outputs.
