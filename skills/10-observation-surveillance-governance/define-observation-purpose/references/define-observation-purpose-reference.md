# Define Observation Purpose Reference

## When To Read

Read this reference when using `define-observation-purpose` for observation authorization, necessity, purpose, assignment governance, field records, third-party minimization, or compliance review.
