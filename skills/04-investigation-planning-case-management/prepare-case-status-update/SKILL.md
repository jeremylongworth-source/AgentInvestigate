...
Summarizes case status, completed work, open items, blockers, risks, decisions, and next steps. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case status update.
...
- Supplied facts, records, sources, actions, or decisions relevant to case status update.
...
- Read `references/prepare-case-status-update-reference.md` when preparing case status update outputs.
