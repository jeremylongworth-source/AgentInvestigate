# Prepare Case Status Update Reference

## When To Read

Read this reference when using `prepare-case-status-update` to prepare, update, review, or close case-management material.
