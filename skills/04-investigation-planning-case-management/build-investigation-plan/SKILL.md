...
Builds a professional investigation plan with objectives, questions, tasks, constraints, dependencies, and review points. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close investigation plan.
...
- Supplied facts, records, sources, actions, or decisions relevant to investigation plan.
...
- Read `references/build-investigation-plan-reference.md` when preparing investigation plan outputs.
