...
Identifies unanswered questions, missing evidence, unsupported inferences, stale items, and review needs. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case gaps.
...
- Supplied facts, records, sources, actions, or decisions relevant to case gaps.
...
- Read `references/identify-case-gaps-reference.md` when preparing case gaps outputs.
