...
Defines milestones, owners, inputs, decision points, dependencies, and completion criteria. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case milestones.
...
- Supplied facts, records, sources, actions, or decisions relevant to case milestones.
...
- Read `references/define-case-milestones-reference.md` when preparing case milestones outputs.
