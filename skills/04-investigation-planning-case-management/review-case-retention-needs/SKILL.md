...
Identifies retention, preservation, hold, disposal, minimization, and reviewer needs for case records. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case retention needs.
...
- Supplied facts, records, sources, actions, or decisions relevant to case retention needs.
...
- Canonical taxonomy dependency: `review-retention-obligation`.
...
- Read `references/review-case-retention-needs-reference.md` when preparing case retention needs outputs.
