# Review Case Retention Needs Reference

## When To Read

Read this reference when using `review-case-retention-needs` to prepare, update, review, or close case-management material.
