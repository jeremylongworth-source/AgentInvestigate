...
Drafts factual case notes that separate observations, statements, actions, inferences, and unknowns. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case notes.
...
- Supplied facts, records, sources, actions, or decisions relevant to case notes.
...
- Read `references/write-case-notes-reference.md` when preparing case notes outputs.
