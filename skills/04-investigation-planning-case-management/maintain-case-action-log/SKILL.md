...
Structures case actions with timestamps, actors, source links, status, follow-ups, and limitations. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case action log.
...
- Supplied facts, records, sources, actions, or decisions relevant to case action log.
...
- Read `references/maintain-case-action-log-reference.md` when preparing case action log outputs.
