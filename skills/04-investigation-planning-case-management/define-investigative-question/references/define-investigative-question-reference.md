# Define Investigative Question Reference

## When To Read

Read this reference when using `define-investigative-question` to prepare, update, review, or close case-management material.
