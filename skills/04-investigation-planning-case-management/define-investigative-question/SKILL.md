...
Turns a scoped matter into answerable, neutral investigative questions and separates facts from desired findings. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close investigative questions.
...
- Supplied facts, records, sources, actions, or decisions relevant to investigative questions.
...
- Read `references/define-investigative-question-reference.md` when preparing investigative questions outputs.
