...
Summarizes scope, work performed, evidence, findings limits, open gaps, disposition, retention, and review needs. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close case closure summary.
...
- Supplied facts, records, sources, actions, or decisions relevant to case closure summary.
...
- Canonical taxonomy dependency: `identify-case-gaps`.
...
- Read `references/prepare-case-closure-summary-reference.md` when preparing case closure summary outputs.
