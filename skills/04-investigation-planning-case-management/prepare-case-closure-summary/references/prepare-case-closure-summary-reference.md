# Prepare Case Closure Summary Reference

## When To Read

Read this reference when using `prepare-case-closure-summary` to prepare, update, review, or close case-management material.
