...
Ranks supplied leads by relevance, source strength, feasibility, authority, proportionality, and review needs. This is a `ROUTINE` case-planning and case-management skill for bounded professional investigation work.

## Triggers

- User asks to plan, structure, review, update, or close investigative leads.
...
- Supplied facts, records, sources, actions, or decisions relevant to investigative leads.
...
- Read `references/prioritize-investigative-leads-reference.md` when preparing investigative leads outputs.
