# Prioritize Investigative Leads Reference

## When To Read

Read this reference when using `prioritize-investigative-leads` to prepare, update, review, or close case-management material.
