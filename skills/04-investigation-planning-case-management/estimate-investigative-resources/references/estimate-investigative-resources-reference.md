# Estimate Investigative Resources Reference

## When To Read

Read this reference when using `estimate-investigative-resources` to prepare, update, review, or close case-management material.
