...
Checks supplied consent records, scope, identity, timing, and gaps for personal screening and due diligence. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review screening consent.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to screening consent.
...
- Canonical taxonomy dependency: `assess-background-screening-authority`.
...
- Read `references/verify-screening-consent-reference.md` when preparing screening consent outputs.
