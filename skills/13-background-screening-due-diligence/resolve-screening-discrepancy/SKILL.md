...
Organizes discrepancies without suppressing conflicts, overstating matches, or deciding adverse outcomes. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review screening discrepancy.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to screening discrepancy.
...
- Canonical taxonomy dependency: `identify-screening-identity-ambiguity`.
...
- Read `references/resolve-screening-discrepancy-reference.md` when preparing screening discrepancy outputs.
