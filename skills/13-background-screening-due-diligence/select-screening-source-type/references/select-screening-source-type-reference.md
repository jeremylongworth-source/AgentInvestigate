# Select Screening Source Type Reference

## When To Read

Read this reference when using `select-screening-source-type` for background screening or entity due diligence involving purpose, authority, consent, public records, source reliability, record relevance, conflicting identities, adverse information, unresolved records, bias risk, or summaries.
