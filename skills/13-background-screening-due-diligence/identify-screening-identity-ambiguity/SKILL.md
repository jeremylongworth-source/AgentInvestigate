...
Identifies identity ambiguity and prevents unsupported matches, conflation, or overclaiming. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review screening identity ambiguity.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to screening identity ambiguity.
...
- Canonical taxonomy dependency: `assess-identity-ambiguity`.
...
- Read `references/identify-screening-identity-ambiguity-reference.md` when preparing screening identity ambiguity outputs.
