...
Flags adverse information for relevance, source, identity, bias, consent, and reviewer checks before use. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review adverse information review need.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to adverse information review need.
...
- Canonical taxonomy dependency: `evaluate-record-relevance`.
...
- Read `references/identify-adverse-information-review-need-reference.md` when preparing adverse information review need outputs.
