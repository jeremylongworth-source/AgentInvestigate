...
Assesses whether supplied authority context is sufficient for bounded screening support and identifies missing gates. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review background-screening authority.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to background-screening authority.
...
- Canonical taxonomy dependency: `define-screening-purpose`.
...
- Read `references/assess-background-screening-authority-reference.md` when preparing background-screening authority outputs.
