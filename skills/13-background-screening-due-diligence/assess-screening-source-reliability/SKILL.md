...
Assesses source reliability and flags stale, unverifiable, conflicting, or unsuitable screening records. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review screening source reliability.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to screening source reliability.
...
- Canonical taxonomy dependency: `select-screening-source-type`.
...
- Read `references/assess-screening-source-reliability-reference.md` when preparing screening source reliability outputs.
