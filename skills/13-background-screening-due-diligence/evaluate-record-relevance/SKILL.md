...
Evaluates relevance, proportionality, age, source limits, and role fit for records under screening controls. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review record relevance.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to record relevance.
...
- Canonical taxonomy dependency: `assess-screening-source-reliability`.
...
- Read `references/evaluate-record-relevance-reference.md` when preparing record relevance outputs.
