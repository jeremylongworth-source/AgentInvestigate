...
Defines a bounded screening or due-diligence purpose while separating personal screening from entity due diligence. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review screening purpose.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to screening purpose.
...
- Read `references/define-screening-purpose-reference.md` when preparing screening purpose outputs.
