...
Prepares summaries that separate person screening from entity due diligence and preserve limits. This is an `INTRUSIVE` background screening and due diligence skill for professional investigation support.
...
- User asks to define, assess, verify, select, evaluate, identify, resolve, prepare, or review due-diligence summary.
...
- Supplied records, public records, source descriptions, source provenance, identifiers, entity details, adverse information, conflicts, unresolved records, or draft summary relevant to due-diligence summary.
...
- Canonical taxonomy dependency: `resolve-screening-discrepancy`.
...
- Read `references/prepare-due-diligence-summary-reference.md` when preparing due-diligence summary outputs.
