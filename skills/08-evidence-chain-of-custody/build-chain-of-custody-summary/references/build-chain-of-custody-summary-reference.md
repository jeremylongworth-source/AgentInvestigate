# Build Chain Of Custody Summary Reference

## When To Read

Read this reference when using `build-chain-of-custody-summary` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
