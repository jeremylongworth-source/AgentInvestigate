# Verify Evidence Timestamp Reference

## When To Read

Read this reference when using `verify-evidence-timestamp` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
