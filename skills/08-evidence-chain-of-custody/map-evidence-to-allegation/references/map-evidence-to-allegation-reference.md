# Map Evidence To Allegation Reference

## When To Read

Read this reference when using `map-evidence-to-allegation` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
