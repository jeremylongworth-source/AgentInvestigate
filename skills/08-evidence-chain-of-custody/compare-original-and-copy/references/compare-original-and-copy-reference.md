# Compare Original And Copy Reference

## When To Read

Read this reference when using `compare-original-and-copy` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
