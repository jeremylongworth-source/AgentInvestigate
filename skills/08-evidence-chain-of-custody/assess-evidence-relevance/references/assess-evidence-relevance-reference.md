# Assess Evidence Relevance Reference

## When To Read

Read this reference when using `assess-evidence-relevance` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
