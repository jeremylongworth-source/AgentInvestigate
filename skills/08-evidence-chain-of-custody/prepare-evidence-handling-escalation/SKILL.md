...
Prepares escalation notes for evidence handling gaps, legal/reviewer questions, preservation issues, and chain concerns. This is a `REGULATED` evidence and chain-of-custody skill for professional investigation and security support.

## Triggers

- User asks to create, classify, record, assess, summarize, identify, track, compare, verify, map, or escalate evidence handling escalation.
...
- Supplied evidence item details, source, original/copy status, custodian, transfer, timestamp, storage, or continuity record relevant to evidence handling escalation.
...
- Canonical taxonomy dependency: `identify-evidence-continuity-issue`.
...
- Read `references/prepare-evidence-handling-escalation-reference.md` when preparing evidence handling escalation outputs.
