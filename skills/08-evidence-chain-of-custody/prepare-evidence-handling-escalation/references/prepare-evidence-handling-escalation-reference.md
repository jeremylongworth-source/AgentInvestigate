# Prepare Evidence Handling Escalation Reference

## When To Read

Read this reference when using `prepare-evidence-handling-escalation` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
