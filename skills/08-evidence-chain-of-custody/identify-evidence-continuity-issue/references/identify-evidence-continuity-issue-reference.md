# Identify Evidence Continuity Issue Reference

## When To Read

Read this reference when using `identify-evidence-continuity-issue` for evidence logging, source recording, custody summaries, continuity gap spotting, transfer tracking, original/copy comparison, timestamp review, allegation mapping, or evidence-handling escalation.
