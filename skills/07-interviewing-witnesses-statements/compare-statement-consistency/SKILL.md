...
Compares statement alignment, conflicts, omissions, chronology, source limits, and unresolved differences. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review statement consistency.
...
- Interview objective, question set, statement, note, or source material relevant to statement consistency.
...
- Canonical taxonomy dependency: `summarize-witness-statement`.
...
- Read `references/compare-statement-consistency-reference.md` when preparing statement consistency outputs.
