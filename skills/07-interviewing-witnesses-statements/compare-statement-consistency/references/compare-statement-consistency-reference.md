# Compare Statement Consistency Reference

## When To Read

Read this reference when using `compare-statement-consistency` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
