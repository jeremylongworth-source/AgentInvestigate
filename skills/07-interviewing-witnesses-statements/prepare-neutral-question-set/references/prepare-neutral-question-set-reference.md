# Prepare Neutral Question Set Reference

## When To Read

Read this reference when using `prepare-neutral-question-set` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
