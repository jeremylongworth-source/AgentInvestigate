...
Drafts open, neutral, non-leading questions aligned to interview objectives and known information gaps. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review neutral question set.
...
- Interview objective, question set, statement, note, or source material relevant to neutral question set.
...
- Canonical taxonomy dependency: `define-interview-objectives`.
...
- Read `references/prepare-neutral-question-set-reference.md` when preparing neutral question set outputs.
