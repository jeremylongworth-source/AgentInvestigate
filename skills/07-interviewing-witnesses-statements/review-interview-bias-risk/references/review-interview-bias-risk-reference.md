# Review Interview Bias Risk Reference

## When To Read

Read this reference when using `review-interview-bias-risk` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
