...
Reviews interview material for leading questions, confirmation bias, stereotyping, coercion, and unsupported deception cues. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review interview bias risk.
...
- Interview objective, question set, statement, note, or source material relevant to interview bias risk.
...
- Read `references/review-interview-bias-risk-reference.md` when preparing interview bias risk outputs.
