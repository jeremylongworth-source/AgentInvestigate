# Define Interview Objectives Reference

## When To Read

Read this reference when using `define-interview-objectives` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
