...
Defines interview objectives that are scoped, neutral, answerable, non-coercive, and tied to case questions. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review interview objectives.
...
- Interview objective, question set, statement, note, or source material relevant to interview objectives.
...
- Read `references/define-interview-objectives-reference.md` when preparing interview objectives outputs.
