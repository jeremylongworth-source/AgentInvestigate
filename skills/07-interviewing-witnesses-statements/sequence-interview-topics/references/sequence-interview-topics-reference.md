# Sequence Interview Topics Reference

## When To Read

Read this reference when using `sequence-interview-topics` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
