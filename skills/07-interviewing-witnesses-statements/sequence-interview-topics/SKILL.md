...
Orders interview topics from context and rapport through material issues, gaps, corroboration, and closure. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review interview topic sequence.
...
- Interview objective, question set, statement, note, or source material relevant to interview topic sequence.
...
- Canonical taxonomy dependency: `prepare-neutral-question-set`.
...
- Read `references/sequence-interview-topics-reference.md` when preparing interview topic sequence outputs.
