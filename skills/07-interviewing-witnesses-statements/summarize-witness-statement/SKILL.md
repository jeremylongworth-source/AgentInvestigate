...
Summarizes witness statements with source limits, direct claims, context, uncertainties, and follow-up needs. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review witness statement.
...
- Interview objective, question set, statement, note, or source material relevant to witness statement.
...
- Canonical taxonomy dependency: `write-case-notes`.
...
- Read `references/summarize-witness-statement-reference.md` when preparing witness statement outputs.
