...
Drafts follow-up questions that clarify gaps, contradictions, chronology, sources, and corroboration without leading. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review follow-up questions.
...
- Interview objective, question set, statement, note, or source material relevant to follow-up questions.
...
- Canonical taxonomy dependency: `identify-corroboration-needs`.
...
- Read `references/prepare-follow-up-questions-reference.md` when preparing follow-up questions outputs.
