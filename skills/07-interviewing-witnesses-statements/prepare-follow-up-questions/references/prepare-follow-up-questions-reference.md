# Prepare Follow Up Questions Reference

## When To Read

Read this reference when using `prepare-follow-up-questions` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
