...
Prepares a witness interview plan with objectives, topics, neutral questions, constraints, records, and escalation points. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review witness interview plan.
...
- Interview objective, question set, statement, note, or source material relevant to witness interview plan.
...
- Canonical taxonomy dependency: `sequence-interview-topics`.
...
- Read `references/prepare-witness-interview-plan-reference.md` when preparing witness interview plan outputs.
