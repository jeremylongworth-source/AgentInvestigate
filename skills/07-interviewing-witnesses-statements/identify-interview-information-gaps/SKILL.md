...
Identifies missing facts, unclear statements, unsupported assumptions, source gaps, and needed follow-up areas. This is a `ROUTINE` interviewing, witnesses, and statements skill for neutral professional investigation support.

## Triggers

- User asks to define, prepare, sequence, identify, summarize, compare, corroborate, follow up, or review interview information gaps.
...
- Interview objective, question set, statement, note, or source material relevant to interview information gaps.
...
- Canonical taxonomy dependency: `define-investigative-question`.
...
- Read `references/identify-interview-information-gaps-reference.md` when preparing interview information gaps outputs.
