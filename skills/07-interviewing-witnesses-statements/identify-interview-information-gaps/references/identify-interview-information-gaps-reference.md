# Identify Interview Information Gaps Reference

## When To Read

Read this reference when using `identify-interview-information-gaps` for neutral interview, witness, statement, consistency, corroboration, follow-up, or bias-review work.
