...
Prepares workplace investigation reports that preserve allegations, scope, policy, interviews, evidence, findings, limits, and review needs. This is a `ROUTINE` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace investigation report.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace investigation report.
...
- Canonical taxonomy dependency: `draft-workplace-finding`.
...
- Read `references/prepare-workplace-investigation-report-reference.md` when preparing workplace investigation report outputs.
