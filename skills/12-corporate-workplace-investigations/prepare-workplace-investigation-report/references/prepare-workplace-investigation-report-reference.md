# Prepare Workplace Investigation Report Reference

## When To Read

Read this reference when using `prepare-workplace-investigation-report` for workplace allegation classification, policy mapping, allegations matrices, investigation planning, evidence source identification, interview planning, statement comparison, evidentiary support, findings, or reports.
