# Prepare Workplace Interview Plan Reference

## When To Read

Read this reference when using `prepare-workplace-interview-plan` for workplace allegation classification, policy mapping, allegations matrices, investigation planning, evidence source identification, interview planning, statement comparison, evidentiary support, findings, or reports.
