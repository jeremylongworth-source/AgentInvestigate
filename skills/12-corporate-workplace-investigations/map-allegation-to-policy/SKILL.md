...
Maps allegations to supplied policies, clauses, conduct categories, evidence needs, and review gaps. This is a `ROUTINE` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace allegation policy map.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace allegation policy map.
...
- Canonical taxonomy dependency: `classify-workplace-allegation`.
...
- Read `references/map-allegation-to-policy-reference.md` when preparing workplace allegation policy map outputs.
