# Map Allegation To Policy Reference

## When To Read

Read this reference when using `map-allegation-to-policy` for workplace allegation classification, policy mapping, allegations matrices, investigation planning, evidence source identification, interview planning, statement comparison, evidentiary support, findings, or reports.
