...
Compares workplace statements while preserving facts, claims, contradictions, corroboration needs, bias risks, and limits. This is a `ROUTINE` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace statement comparison.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace statement comparison.
...
- Read `references/compare-workplace-statements-reference.md` when preparing workplace statement comparison outputs.
