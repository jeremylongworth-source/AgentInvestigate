...
Plans workplace investigations with scope, authority, policy, evidence, interviews, sequencing, privacy, and reviewer gates. This is a `REGULATED` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace investigation plan.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace investigation plan.
...
- Canonical taxonomy dependency: `build-allegations-matrix`.
- Canonical taxonomy dependency: `prepare-authority-check`.
...
- Read `references/plan-workplace-investigation-reference.md` when preparing workplace investigation plan outputs.
