...
Classifies workplace allegations by issue type, scope, policy area, authority needs, sensitivity, and review path. This is a `REGULATED` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace allegation classification.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace allegation classification.
...
- Read `references/classify-workplace-allegation-reference.md` when preparing workplace allegation classification outputs.
