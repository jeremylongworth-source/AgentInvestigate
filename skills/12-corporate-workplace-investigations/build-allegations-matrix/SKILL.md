...
Builds allegations matrices that separate allegation, policy, facts, evidence, gaps, findings status, and limits. This is a `ROUTINE` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace allegations matrix.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace allegations matrix.
...
- Canonical taxonomy dependency: `map-allegation-to-policy`.
...
- Read `references/build-allegations-matrix-reference.md` when preparing workplace allegations matrix outputs.
