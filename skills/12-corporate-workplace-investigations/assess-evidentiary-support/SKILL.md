...
Assesses support, contradictions, source weight, gaps, and confidence for workplace allegations or draft findings. This is a `ROUTINE` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace evidentiary support.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace evidentiary support.
...
- Canonical taxonomy dependency: `build-evidence-matrix`.
...
- Read `references/assess-evidentiary-support-reference.md` when preparing workplace evidentiary support outputs.
