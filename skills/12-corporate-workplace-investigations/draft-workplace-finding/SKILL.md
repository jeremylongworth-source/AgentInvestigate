...
Drafts workplace findings with support, source limits, contradictions, confidence, unresolved questions, and review needs. This is a `ROUTINE` corporate and workplace investigations skill for professional investigation support.
...
- User asks to classify, map, build, plan, identify, prepare, compare, assess, draft, or report workplace finding.
...
- Supplied policy, allegation classification, allegations matrix, interview plan, evidence sources, statements, evidentiary support, findings, or report material relevant to workplace finding.
...
- Canonical taxonomy dependency: `assess-evidentiary-support`.
...
- Read `references/draft-workplace-finding-reference.md` when preparing workplace finding outputs.
