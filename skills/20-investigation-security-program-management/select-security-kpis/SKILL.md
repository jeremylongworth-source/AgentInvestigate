...
Selects security KPIs for incidents, patrol/log quality, response records, control gaps, training, and improvement. This is a `ROUTINE` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify security KPIs.
...
- Supplied facts relevant to security KPIs, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Read `references/select-security-kpis-reference.md` when preparing security KPIs outputs.
