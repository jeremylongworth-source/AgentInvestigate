...
Reviews investigative procedures against supplied policy, authority, evidence, privacy, and escalation requirements. This is a `REGULATED` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify investigative procedure review.
...
- Supplied facts relevant to investigative procedure review, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `draft-investigative-policy`.
...
- Read `references/review-investigative-procedure-reference.md` when preparing investigative procedure review outputs.
