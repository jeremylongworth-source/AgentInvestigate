...
Selects investigation KPIs for timeliness, quality, source support, backlog, milestones, and review status. This is a `ROUTINE` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify investigation KPIs.
...
- Supplied facts relevant to investigation KPIs, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `define-case-milestones`.
...
- Read `references/select-investigation-kpis-reference.md` when preparing investigation KPIs outputs.
