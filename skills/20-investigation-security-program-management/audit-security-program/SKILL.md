...
Audits security programs for governance, coverage, controls, incidents, training, KPIs, and corrective actions. This is a `REGULATED` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify security program audit.
...
- Supplied facts relevant to security program audit, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `review-security-procedure`.
...
- Read `references/audit-security-program-reference.md` when preparing security program audit outputs.
