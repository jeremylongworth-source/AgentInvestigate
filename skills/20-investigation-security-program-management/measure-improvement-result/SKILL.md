...
Measures improvement results against baselines, KPIs, corrective actions, verification evidence, and residual gaps. This is a `ROUTINE` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify improvement measurement.
...
- Supplied facts relevant to improvement measurement, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `track-corrective-action`.
...
- Read `references/measure-improvement-result-reference.md` when preparing improvement measurement outputs.
