...
Drafts bounded security post orders, duties, escalation paths, reporting expectations, and review gates. This is a `REGULATED` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify security post orders.
...
- Supplied facts relevant to security post orders, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Read `references/draft-security-post-orders-reference.md` when preparing security post orders outputs.
