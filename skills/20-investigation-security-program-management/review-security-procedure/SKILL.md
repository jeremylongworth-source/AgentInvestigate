...
Reviews security procedures against supplied post orders, site duties, authority, safety, and reporting needs. This is a `REGULATED` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify security procedure review.
...
- Supplied facts relevant to security procedure review, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `draft-security-post-orders`.
...
- Read `references/review-security-procedure-reference.md` when preparing security procedure review outputs.
