# Review Training Requirement Reference

## When To Read

Read this reference when using `review-training-requirement` for investigation and security program management work involving investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, improvement measurement, composition targets, or qualified-review escalation.
