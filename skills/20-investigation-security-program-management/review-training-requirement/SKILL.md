...
Reviews training requirements, qualification boundaries, refresher needs, evidence of completion, and escalation gaps. This is a `REGULATED` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify training requirement review.
...
- Supplied facts relevant to training requirement review, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `review-training-requirements`.
...
- Read `references/review-training-requirement-reference.md` when preparing training requirement review outputs.
