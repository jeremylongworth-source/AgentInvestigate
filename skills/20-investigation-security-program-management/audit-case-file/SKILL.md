...
Audits case files for required records, notes, evidence mapping, source support, gaps, and review status. This is a `ROUTINE` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify case file audit.
...
- Supplied facts relevant to case file audit, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `conduct-case-file-review`.
...
- Read `references/audit-case-file-reference.md` when preparing case file audit outputs.
