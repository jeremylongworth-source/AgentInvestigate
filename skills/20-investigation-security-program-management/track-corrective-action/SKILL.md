...
Tracks corrective action owners, dates, status, evidence, dependencies, verification, and escalation needs. This is a `ROUTINE` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify corrective action.
...
- Supplied facts relevant to corrective action, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Canonical taxonomy dependency: `identify-corrective-action`.
...
- Read `references/track-corrective-action-reference.md` when preparing corrective action outputs.
