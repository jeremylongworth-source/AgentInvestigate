...
Drafts investigative policy language, roles, controls, evidence handling, review gates, and governance limits. This is a `REGULATED` investigation and security program management skill.
...
- User asks to draft, review, audit, select, track, measure, prepare, or identify investigative policy.
...
- Supplied facts relevant to investigative policy, including investigative policy, security post orders, procedure review, file audits, program audits, KPIs, training requirements, corrective action, and improvement measurement where applicable.
...
- Read `references/draft-investigative-policy-reference.md` when preparing investigative policy outputs.
