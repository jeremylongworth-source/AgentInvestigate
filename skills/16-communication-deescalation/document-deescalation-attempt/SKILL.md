...
Documents de-escalation attempts with neutral facts, words used, response, limits, and follow-up needs. This is a `ROUTINE` communication and de-escalation skill for professional security support.
...
- User asks to triage, determine, support, preserve, identify, document, collect, prepare, assess, draft, adapt, review, or communicate de-escalation attempt.
...
- Supplied facts relevant to de-escalation attempt, including dates, times, locations, people or roles, observations, incident conditions, communications, notifications, actions already taken, records, and open issues where applicable.
...
- Canonical taxonomy dependency: `prepare-deescalation-communication-plan`.
...
- Read `references/document-deescalation-attempt-reference.md` when preparing de-escalation attempt outputs.
