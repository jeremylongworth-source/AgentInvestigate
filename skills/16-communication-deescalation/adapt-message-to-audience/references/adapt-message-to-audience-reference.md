# Adapt Message To Audience Reference

## When To Read

Read this reference when using `adapt-message-to-audience` for incident response, communication, de-escalation, emergency-service support, scene preservation, notification, radio communication, audience adaptation, bias review, documentation, post-incident review, or escalation support.
