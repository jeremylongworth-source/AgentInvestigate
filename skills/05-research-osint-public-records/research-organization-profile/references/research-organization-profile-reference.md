# Research Organization Profile Reference

## When To Read

Read this reference when using `research-organization-profile` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
