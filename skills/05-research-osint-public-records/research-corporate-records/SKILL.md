...
Structures corporate-record research using lawful source categories, jurisdiction facts, provenance, and review needs. This is a `REGULATED` research, OSINT, and public-records skill for lawful professional investigation work.

## Triggers

- User asks to plan, conduct, structure, assess, corroborate, or summarize corporate records research.
...
- Read `references/research-corporate-records-reference.md` when preparing corporate records research outputs.
