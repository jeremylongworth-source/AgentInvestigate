...
Assesses source type, provenance, freshness, independence, corroboration, bias, and reliability limits. This is a `ROUTINE` research, OSINT, and public-records skill for lawful professional investigation work.

## Triggers

- User asks to plan, conduct, structure, assess, corroborate, or summarize source reliability.
...
- Read `references/assess-source-reliability-reference.md` when preparing source reliability outputs.
