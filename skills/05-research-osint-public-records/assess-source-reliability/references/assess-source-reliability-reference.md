# Assess Source Reliability Reference

## When To Read

Read this reference when using `assess-source-reliability` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
