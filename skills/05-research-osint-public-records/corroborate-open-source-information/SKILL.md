...
Compares claims across independent sources, provenance, timing, conflicts, and confidence limits. This is a `ROUTINE` research, OSINT, and public-records skill for lawful professional investigation work.

## Triggers

- User asks to plan, conduct, structure, assess, corroborate, or summarize open-source corroboration.
...
- Read `references/corroborate-open-source-information-reference.md` when preparing open-source corroboration outputs.
