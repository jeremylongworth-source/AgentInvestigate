# Corroborate Open Source Information Reference

## When To Read

Read this reference when using `corroborate-open-source-information` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
