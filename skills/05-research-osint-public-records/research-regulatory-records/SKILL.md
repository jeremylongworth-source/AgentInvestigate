...
Structures regulatory-record research with source hierarchy, jurisdiction, provenance, freshness, and reviewer needs. This is a `REGULATED` research, OSINT, and public-records skill for lawful professional investigation work.

## Triggers

- User asks to plan, conduct, structure, assess, corroborate, or summarize regulatory records research.
...
- Read `references/research-regulatory-records-reference.md` when preparing regulatory records research outputs.
