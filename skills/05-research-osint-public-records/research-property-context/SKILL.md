...
Structures property-context research with jurisdiction, lawful record categories, site-safety boundaries, and source limits. This is a `REGULATED` research, OSINT, and public-records skill for lawful professional investigation work.

## Triggers

- User asks to plan, conduct, structure, assess, corroborate, or summarize property context research.
...
- Canonical taxonomy dependency: `identify-public-record-sources`.
...
Default class: `REGULATED`. Provide source-backed issue spotting and research framing. Fail closed when jurisdiction, authority, lawful access basis, source freshness, or qualified review is missing. Do not make final legal, licensing, privacy, employment, admissibility, or compliance determinations.
...
- Read `references/research-property-context-reference.md` when preparing property context research outputs.
