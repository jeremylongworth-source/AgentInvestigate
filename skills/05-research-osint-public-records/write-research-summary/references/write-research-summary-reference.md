# Write Research Summary Reference

## When To Read

Read this reference when using `write-research-summary` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
