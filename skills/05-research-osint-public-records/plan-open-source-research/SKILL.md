...
Plans open-source research paths, search questions, source limits, provenance capture, and safety boundaries. This is a `ROUTINE` research, OSINT, and public-records skill for lawful professional investigation work.

## Triggers

- User asks to plan, conduct, structure, assess, corroborate, or summarize open-source research.
...
- Read `references/plan-open-source-research-reference.md` when preparing open-source research outputs.
