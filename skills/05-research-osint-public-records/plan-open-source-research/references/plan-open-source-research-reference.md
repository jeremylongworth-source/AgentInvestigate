# Plan Open Source Research Reference

## When To Read

Read this reference when using `plan-open-source-research` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
