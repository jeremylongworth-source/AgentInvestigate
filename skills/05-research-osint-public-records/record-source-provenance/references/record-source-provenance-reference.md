# Record Source Provenance Reference

## When To Read

Read this reference when using `record-source-provenance` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
