# Research Court Records Reference

## When To Read

Read this reference when using `research-court-records` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
