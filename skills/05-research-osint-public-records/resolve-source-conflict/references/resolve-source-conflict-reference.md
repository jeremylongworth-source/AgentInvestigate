# Resolve Source Conflict Reference

## When To Read

Read this reference when using `resolve-source-conflict` for research, OSINT, public-records, provenance, reliability, corroboration, conflict, or summary work.
