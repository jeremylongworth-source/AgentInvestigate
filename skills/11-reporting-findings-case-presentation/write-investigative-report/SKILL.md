...
Writes investigative reports that separate facts, sources, evidence, inferences, limitations, unresolved questions, and confidence. This is a `ROUTINE` reporting, findings, and case-presentation skill for professional investigation support.

## Triggers

- User asks to write, prepare, summarize, review, present, outline, or identify investigative report.
...
- Supplied facts, sources, evidence records, chronology, findings, allegations, inferences, limitations, unresolved questions, and confidence context relevant to investigative report.
...
- Canonical taxonomy dependency: `draft-investigative-finding`.
...
- Read `references/write-investigative-report-reference.md` when preparing investigative report outputs.
