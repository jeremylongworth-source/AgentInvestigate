...
Triages loss-prevention incidents for immediate safety, authority, evidence, notification, escalation, and documentation needs. This is a `REGULATED` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build loss prevention incident.
...
- Supplied facts relevant to loss prevention incident, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Canonical taxonomy dependency: `analyze-loss-event`.
...
Default class: `REGULATED`. Upgrade to `REGULATED`, `INTRUSIVE`, or `CERTIFICATION_BOUNDARY` when loss-prevention work involves personal information, employee or customer allegations, surveillance records, access logs, suspected crime, law-enforcement referral, employment consequences, detention, search, pursuit, physical intervention, privacy issues, or material consequences.
...
- Read `references/triage-loss-prevention-incident-reference.md` when preparing loss prevention incident outputs.
