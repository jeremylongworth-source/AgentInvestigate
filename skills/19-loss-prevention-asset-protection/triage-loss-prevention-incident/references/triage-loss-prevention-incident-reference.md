# Triage Loss Prevention Incident Reference

## When To Read

Read this reference when using `triage-loss-prevention-incident` for loss prevention and asset protection work involving asset protection risk, loss events, shrink patterns, loss prevention incidents, evidence mapping, process-control weaknesses, case summaries, improvement plans, composition targets, or qualified-review escalation.
