...
Analyzes loss events for chronology, source records, control gaps, evidence status, uncertainties, and escalation needs. This is a `ROUTINE` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build loss event.
...
- Supplied facts relevant to loss event, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Read `references/analyze-loss-event-reference.md` when preparing loss event outputs.
