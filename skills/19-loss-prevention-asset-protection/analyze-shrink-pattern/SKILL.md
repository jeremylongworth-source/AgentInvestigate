...
Analyzes shrink patterns, inventory variance themes, data limits, plausible explanations, and review questions. This is a `ROUTINE` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build shrink pattern.
...
- Supplied facts relevant to shrink pattern, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Read `references/analyze-shrink-pattern-reference.md` when preparing shrink pattern outputs.
