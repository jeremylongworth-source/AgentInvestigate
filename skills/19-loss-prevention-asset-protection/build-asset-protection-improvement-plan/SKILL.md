...
Builds asset-protection improvement plans with prioritized controls, owners, evidence basis, metrics, and review gates. This is a `ROUTINE` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build improvement plan.
...
- Supplied facts relevant to improvement plan, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Canonical taxonomy dependency: `prepare-loss-prevention-case-summary`.
...
- Read `references/build-asset-protection-improvement-plan-reference.md` when preparing improvement plan outputs.
