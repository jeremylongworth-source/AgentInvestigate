...
Assesses asset-protection risk, vulnerable assets, loss drivers, existing controls, gaps, and improvement questions. This is a `ROUTINE` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build asset protection risk.
...
- Supplied facts relevant to asset protection risk, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Read `references/assess-asset-protection-risk-reference.md` when preparing asset protection risk outputs.
