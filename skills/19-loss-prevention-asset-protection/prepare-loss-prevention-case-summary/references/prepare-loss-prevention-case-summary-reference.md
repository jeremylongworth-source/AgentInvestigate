# Prepare Loss Prevention Case Summary Reference

## When To Read

Read this reference when using `prepare-loss-prevention-case-summary` for loss prevention and asset protection work involving asset protection risk, loss events, shrink patterns, loss prevention incidents, evidence mapping, process-control weaknesses, case summaries, improvement plans, composition targets, or qualified-review escalation.
