...
Prepares bounded loss-prevention case summaries with facts, sources, evidence, assumptions, gaps, and escalation notes. This is a `ROUTINE` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build case summary.
...
- Supplied facts relevant to case summary, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Canonical taxonomy dependency: `identify-process-control-weakness`.
...
- Read `references/prepare-loss-prevention-case-summary-reference.md` when preparing case summary outputs.
