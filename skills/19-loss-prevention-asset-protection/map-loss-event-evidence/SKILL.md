...
Maps loss-event evidence, records, source provenance, chain-of-custody status, contradictions, and unresolved questions. This is a `ROUTINE` loss prevention and asset protection skill for professional investigative and security support.
...
- User asks to assess, analyze, triage, map, identify, prepare, or build loss event evidence.
...
- Supplied facts relevant to loss event evidence, including asset protection risk, loss event, shrink pattern, loss prevention incident, loss event evidence, process control weakness, case summary, and improvement plan where applicable.
...
- Read `references/map-loss-event-evidence-reference.md` when preparing loss event evidence outputs.
