...
- Roadmap: `ROADMAP.md`
- Latest completed wave: `AI-16 Investigative Analysis`
- Recommended next wave: `AI-17 Reporting, Findings & Case Presentation`
...
- Latest handoff: `docs/development/handoffs/AI-16-final-handoff.md`
