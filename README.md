...
- Roadmap: `ROADMAP.md`
- Latest completed wave: `AI-35 Specialized Investigation Framework`
- Recommended next wave: `AI-36 Public Documentation & Repository Readiness`
...
- Ontario specialization: `specializations/canada/ontario/README.md`
- Ontario regulatory scenarios: `tests/regulatory/AI-28-ontario-specialization.json`
- British Columbia specialization: `specializations/canada/british-columbia/README.md`
- British Columbia regulatory scenarios: `tests/regulatory/AI-29-british-columbia-specialization.json`
- Alberta specialization: `specializations/canada/alberta/README.md`
- Alberta regulatory scenarios: `tests/regulatory/AI-30-alberta-specialization.json`
- Canadian jurisdiction roadmap: `docs/architecture/canadian-jurisdiction-roadmap.md`
- Canadian jurisdiction framework scenarios: `tests/regulatory/AI-31-canadian-jurisdiction-framework.json`
...
- Adversarial safety evaluation: `docs/evaluation/adversarial-safety-misuse-evaluation.md`
- Adversarial safety scenarios: `tests/safety/AI-34-adversarial-safety-misuse-scenarios.json`
- Specialization roadmap: `docs/architecture/specialization-roadmap.md`
- Latest handoff: `docs/development/handoffs/AI-35-final-handoff.md`
