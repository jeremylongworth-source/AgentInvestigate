...
- Roadmap: `ROADMAP.md`
- Latest completed wave: `AI-17 Reporting, Findings & Case Presentation`
- Recommended next wave: `AI-18 Observation & Surveillance Governance`
...
- Latest handoff: `docs/development/handoffs/AI-17-final-handoff.md`
