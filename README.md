...
- Roadmap: `ROADMAP.md`
- Latest completed wave: `AI-21 Security Operations, Access & Patrol`
- Recommended next wave: `AI-22 Incident Response, Communication & De-escalation`
...
- Latest handoff: `docs/development/handoffs/AI-21-final-handoff.md`
